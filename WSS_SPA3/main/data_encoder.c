...
esp_err_t rmt_new_data_encoder(const data_encoder_config_t *config, rmt_encoder_handle_t *ret_encoder)
{
    ...
    data_encoder->data_rem = (rmt_symbol_word_t) {
        .level0 = 0,
        .duration0 = 10 * WSS_RESOLUTION_HZ / 1000000,
        .level1 = 0,
        .duration1 = (rem - 10) * WSS_RESOLUTION_HZ / 1000000,  // Use [10, (rem-10)] to avoid float divide issues with rem/2
    };
